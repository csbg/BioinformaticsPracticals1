...
Now let's use regulare expressions to explore the fasta file.

But first, have a look at the first few lines.
...
::: {.callout-tip}
If you run gunzip without the "-c", you will unzip the file in your home directory. In this case, get help to remove the unzipped file and get a fresh copy.
:::
...
Create the following files in the directory `day3` (all results should be based on the file `GRCh38_reformatted.gz`):
