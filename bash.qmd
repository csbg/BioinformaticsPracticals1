...
::: {.callout-tip}
Depending on your system, it may be difficult to copy and paste text into nano. If copy/pasting doesn't work in nano, you can also use the text editor that comes with MobaXterm, where copy/pasting should work.
:::
